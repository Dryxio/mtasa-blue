...
constexpr uint16_t MTA_DM_NETCODE_VERSION = 0x040A;  // Netcode version
constexpr uint16_t MTA_DM_VERSION = 0x0160;          // 1.6.0
constexpr uint16_t MTA_DM_BITSTREAM_VERSION = 0x06B; // Latest bitstream version
